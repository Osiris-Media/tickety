...
import com.osiris.tickety.enums.UserRolesEnum;
...
import static com.osiris.tickety.entities.CompanyEntity.TABLE_NAME;
...
public class CompanyEntity extends BaseEntity{
    ...
    public CompanyEntity(final Long id) {
        this.id = id;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof final CompanyEntity other)) {
            return false;
        }
